...
func (pq *PetQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (pq *PetQuery) FirstIDX(ctx context.Context) uint64 {
...
func (pq *PetQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (pq *PetQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (pq *PetQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (pq *PetQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Pet, error) {
	...
	if query := pq.withUser; query != nil {
		if err := pq.loadUser(ctx, query, nodes, nil,
			func(n *Pet, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PetQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Pet, init func(*Pet), assign func(*Pet, *User)) error {
	ids := make([]uint64, 0, len(nodes))
	nodeids := make(map[uint64][]*Pet)
	for i := range nodes {
		fk := nodes[i].UserID
