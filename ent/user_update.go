...
func (uu *UserUpdate) AddPetIDs(ids ...uint64) *UserUpdate {
...
func (uu *UserUpdate) RemovePetIDs(ids ...uint64) *UserUpdate {
...
// AddPetIDs adds the "pets" edge to the Pet entity by IDs.
func (uuo *UserUpdateOne) AddPetIDs(ids ...uint64) *UserUpdateOne {
...
// RemovePetIDs removes the "pets" edge to Pet entities by IDs.
func (uuo *UserUpdateOne) RemovePetIDs(ids ...uint64) *UserUpdateOne {
