...
import (
	...
	"github.com/wonderfate/ent-test-edges/ent/migrate"
...
func (c *PetClient) UpdateOneID(id uint64) *PetUpdateOne {
...
func (c *PetClient) DeleteOneID(id uint64) *PetDeleteOne {
...
func (c *PetClient) Get(ctx context.Context, id uint64) (*Pet, error) {
	return c.Query().Where(pet.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PetClient) GetX(ctx context.Context, id uint64) *Pet {
