...
func (pc *PetCreate) SetUserID(u uint64) *PetCreate {
	pc.mutation.SetUserID(u)
	return pc
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (pc *PetCreate) SetNillableUserID(u *uint64) *PetCreate {
	if u != nil {
		pc.SetUserID(*u)
	}
	return pc
...
func (pc *PetCreate) SetID(u uint64) *PetCreate {
	pc.mutation.SetID(u)
	return pc
}
...
func (pc *PetCreate) check() error {
	if _, ok := pc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required field "Pet.user_id"`)}
	}
	if _, ok := pc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user", err: errors.New(`ent: missing required edge "Pet.user"`)}
	}
	return nil
}
